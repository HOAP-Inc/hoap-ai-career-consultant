...
も続けて聞いていくよ。気楽にどうぞ！`,
  ...
  const valOrEmpty = v => (typeof v === 'string' ? v.trim() : '')
  ...
  return (
    <div className="root">
      ...
      <style jsx>{`
        ...
        .header-inner { max-width: 1100px; margin: 0 auto; padding: 12px 16px; display: flex; justify-content: space-between; gap: 12px; }
        ...
        .scroll { flex: 1 1 auto; height: calc(100vh - 210px); overflow-y: auto; padding: 12px 0; }
        .messages { max-width: 900px; margin: 0 auto; padding: 0 16px; display: flex; flex-direction: column; gap: 12px; }
        .row { display: flex; }
        ...
        .text { white-space: pre-wrap; line-height: 1.7; font-size: 14px; }
        ...
        @media (max-width: 640px) { .scroll { height: calc(100vh - 220px); } .bubble { max-width: 100%; } }
      `}</style>
    </div>
  )
}
