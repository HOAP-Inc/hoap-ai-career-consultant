...
// Must/NG 辞書
const mustWantItems = ['急性期病棟','回復期病棟','慢性期・療養型病院','一般病院','地域包括ケア病棟','療養病棟','緩和ケア病棟（ホスピス）','クリニック','精神科病院','訪問看護ステーション','残業ほぼなし','有給消化率ほぼ100%','年間休日120日以上','日勤のみ可','夜勤専従あり','社会保険完備','交通費支給','副業OK','賞与あり','退職金あり']
// （本当はもっと大量にあるけど省略版、動作確認用）
