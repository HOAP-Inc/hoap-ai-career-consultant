...
const transferReasonFlow = {
  ...
  "働く仲間に関すること": {
  keywords: [
    "人間関係","職場の雰囲気","上司","先輩","同僚","チームワーク","いじめ","パワハラ","セクハラ","陰口","派閥","お局",
  ...
  "労働条件に関すること": {
  keywords: [
    "残業","夜勤","休日","有給","働き方","時間","勤務時間","労働時間","シフト","連勤","休憩",
    "オンコール","呼び出し","副業","兼業","人員配置","定時","サービス残業","就業規則","承認","申請制","半休","時間有休","直行直帰",
    // 運用・拘束・交代制
    "前残業","早出","申し送りの延長","カンファ残業","委員会残業","拘束時間が長い","勤怠システム","勤務表",
    "夜勤回数","仮眠が取れない","2交替","3交替","明け残業","土日固定休が取れない","シフト希望が通らない","人が足りない",
    // ★追加要望（移動手段）
    "移動が自転車","自転車移動","電動自転車"
    "移動が自転車","自転車で訪問","自転車訪問","訪問の移動が自転車",
